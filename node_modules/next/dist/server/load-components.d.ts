...
export declare function loadComponents(distDir: string, pathname: string, serverless: boolean, serverComponents?: boolean, rootEnabled?: boolean): Promise<LoadComponentsReturnType>;
