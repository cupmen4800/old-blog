...
export declare function getPagePath(page: string, distDir: string, serverless: boolean, dev?: boolean, locales?: string[], rootEnabled?: boolean): string;
export declare function requirePage(page: string, distDir: string, serverless: boolean, rootEnabled?: boolean): any;
