...
const Home = ({ allPostsData  })=>{
    ...
    const filter = allPostsData.filter((janle)=>janle.data.janle === "design"
    ).filter((x)=>x.data.category === "movie"
    );
...
var __webpack_exports__ = __webpack_require__.X(0, [505,738,943,776], () => (__webpack_exec__(1692)));
