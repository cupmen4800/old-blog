...
const Home = ({ allPostsData  })=>{
    ...
    const filter = allPostsData.filter((janle)=>janle.data.janle === "seo"
    ).filter((x)=>x.data.category === "youtube"
    );
...
var __webpack_exports__ = __webpack_require__.X(0, [505,738,943,776], () => (__webpack_exec__(9630)));
